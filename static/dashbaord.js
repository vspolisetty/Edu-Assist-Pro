class DashboardManager {
    ...
    updateStats() {
        ...
        // Study time: estimate based on study sessions (15 min per session)
        const studyTimeHours = Math.round((studySessions * 0.25) * 10) / 10; // 15 min = 0.25 hours
        ...
        document.getElementById('study-time').textContent = studyTimeHours > 0 ? `${studyTimeHours}h` : '0h';
